...
from fairchem.registry import registry
from fairchem.atomic_data import AtomicData
from fairchem.base_dataset import BaseDataset
from fairchem.transforms import DataTransforms

if TYPE_CHECKING:
    from collections.abc import Callable

# NOTE: Taken from https://github.com/facebookresearch/fairchem/blob/main/src/fairchem/core/datasets/_utils.py
